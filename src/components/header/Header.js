...
const Header = () => {
    ...
    const elementBody = useMemo(() => document.body, [])

    const toggleMobileMenu = () => {
        setMobileMenu(prev => !prev)
        elementBody.classList.toggle('locked')
    }
            ...
            <div className="container container__inner">
               ...
               <div className="header__right">
                   <div className="contact">
                       <a href="tel:+00 123 456 789" className="contact__number">+00 123 456 789</a>
                       <Button className="btn-blue">
                           Contact Us
                       </Button>
                   </div>
                   <button className={`burger ${mobileMenu && 'active'}`} id="burger"
